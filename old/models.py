...
class OldUser(models.Model):
	...
	activeuser	= models.ForeignKey(User, on_delete=models.CASCADE, related_name="activeuser", blank=True, null=True)
...
class OldJoined(models.Model):
	user		= models.ForeignKey(OldUser, on_delete=models.CASCADE, related_name="user");
	game	    	= models.ForeignKey(OldGame, on_delete=models.CASCADE)
